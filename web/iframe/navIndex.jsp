...
<nav class="navbar navbar-default ">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-form nav navbar-right">
            <li>
                <form action="${pageContext.request.contextPath}/user/selectByName.do" target="_top"
                      class="form-inline form-group-sm" method="post">
                    <input type="text" placeholder="请输入用户名" name="username" class=" form-control"/>
                    <input type="text" placeholder="请输入密码" name="password" class="form-control"/>
