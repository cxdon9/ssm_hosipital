...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8" style="text-align: center;">
            <form class="form-inline" action="${pageContext.request.contextPath}/dept/update.do" method="get">
                <table class="table  table-bordered" style="width:100%;">
                    <tr class="bg-info">
                        <td style="text-align: center;" colspan="2"><span style="font-size: 20px;font-weight: bold;">科室修改</span>
                        </td>
                    </tr>
                    <tr class="active">
                    ...
                    <tr class="active">
                        ...
                        <td><input type="text" style="width: 100%;" placeholder="请输入办公室电话" class="form-control"
                                   name="telephone" value="${department.telephone}"></td>
                    </tr>
                    <tr class="active">
                        ...
                        <td><input type="text" style="width: 100%;" placeholder="请输入所在区域" class="form-control"
                                   name="area" value="${department.area}"></td>
